          ...
          <div className="swiper-btn-wrap">
            <div className="swiper-btn-next">
              <svg className="woox-icon icon-line-arrow-right">
                <use xlinkHref="#icon-line-arrow-right" />
              </svg>
            </div>
            <div className="swiper-btn-prev">
              <svg className="woox-icon icon-line-arrow-left">
                <use xlinkHref="#icon-line-arrow-left" />
              </svg>
            </div>
          </div>
          <div
            className="swiper-container auto-height swiper-unique-id-1 initialized swiper-container-initialized swiper-container-horizontal swiper-container-autoheight"
            data-show-items={5}
            data-prev-next={1}
          ...
          >
            ...
            >
              <div
                ...
                style={{ width: 264, marginRight: 20 }}
              >
